...
const Navbar = () => {
  ...
  <nav>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 fixed cursor-pointer md:hidden left-10 top-6 z-30" onClick={() => setOpen(!open)}>
